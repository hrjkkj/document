/*! TenVideoPlayer_V2 - v2.0.0 - 2017-04-25 18:12:38
 * Copyright (c) 2017
...
function(a) {
	...
	tvp.lastModify = "2017-04-25 18:12:37", tvp.ts = tvp.lastModify.replace(/\D/g, ""), tvp.ver = "$V2.0Build9370$", tvp.dataset = {
		openLazy: !0
	},
	...
	tvp.common = {
		...
		bindNewMethodOnOpenAppInWeixin: function(a) {
			if (a && a.attr && a.on && a.removeAttr && tvp.common.isNewWX("6.5.6")) {
				...
				function() {
					a.removeAttr("href"),
					tvp.common.openAppInWx(a.attr("data-schemeUrl"))
				}).removeAttr("href"))
			}
		}
	},
		...
		return "film.qq.com" == document.location.host && (i = !0),
		{
			getOcx: function(b) {
				...
				if (tvp.$.browser.ie) try {
					f = "IE begin",
					c = new ActiveXObject(e.config.PROGID_QQLIVE_INSTALLER),
					"undefined" != typeof c.getVersion ? (d = c.GetVersionByClsid(e.config.OCX_CLSID), f = "get actObj.GetVersionByClsid:" + d) : f = "no function:actObj.GetVersionByClsid"
				} catch(j) {
					...
					if (k) if (tvp.$.isUndefined(k.version)) {
						...
						o && (d = o[1])
					} else f = "plug.version:" + k.version,
					d = k.version;
					else f = "no plugs[i].filename:npQQLive.dll"
				}
	...
	function(a, b) {
		...
		a.h5Helper = {
			...
			loadVideoUrlByVid_base: function(d, f) {
				...
				d.retryDefer && b.isFunction(d.retryDefer.reject) && (t = !0, q = d.retryDefer, u = k.retryCgi.getinfo, z = k.retryCgi.getkey),
				d.loadingAdCgi && (u = d.loadingAdCgi, d.noAuth = !0),
				d.defer && (q = d.defer),
				y = i({
					itype: 1,
					val2: t ? 1 : 0,
				...
				C = function() {
					...
					b.ajax({
						...
						if (!d.noAuth && c && 0 != c.em && "o" != c.s) {
							if (85 === c.em && -3 === c.type && 1 === d.cgi_auth_index) return d.cgi_auth_index += 1,
							d.defer = q,
							d.needTime = !0,
							d.svr_time = c.curTime,
							void a.h5Helper.loadVideoUrlByVid(d);
							if (83 === c.em && r.eduext);
							else if (! (b.inArray(c.em, [100]) > -1)) return d.noAuth = !0,
							d.defer = q,
							void a.h5Helper.loadVideoUrlByVid(d)
						}
						A(c)
		...
		if (!window.txvLogin) {
			...
			c = {
				ajax: function(a, b, c) {
					...
					if (window.jQuery && jQuery.ajax) d = jQuery.ajax;
						...
						if (! (window.tvp && tvp.$ && tvp.$.ajax)) return void c({
			...
			a.prototype = {
				isLogin: function(a) {
					...
					function() {};
					var b = this;
					return e.isqqlive ? void this.tvGetCookie(["qq", "wx"],
					function(b) {
						var c;
						try {
				...
				getUin: function(a) {
					...
					this.isQQLowLogin(function(d) {
						...
						c ? (c = parseInt(c.replace(/^o0*/g, ""), 10), a(c)) : a(0)
					})
				},
				getSkey: function(a) {
					a = a ||
	...
	e.debug = function(a) {
		...
		tvp.log.isDebug && ("undefined" != typeof __TenVideo_OCX_CTRL_PAGE__ ? e.driverPage.sendMsg(e.DEFINE.MSG.DRVPG_EVT_DEBUGLOG, encodeURIComponent(a)) : tvp.log(a))
	},
	...
	e.version = function() {
		...
		return _version = {},
		{
			...
			check: function(b) {
				...
				e.version.compare(c, b) < 0 ? !1 : !0
			},
			isZero: function(a) {
				return a = a || e.version.get(),
				/^\d+$/.test(a) && 0 == a ? !0 : 0 == e.version.compare(a, "0.0.0.0")
			},
	...
	e.userAgent = e.browser,
	e.installer = {
		timer: null,
		installerObj: null,
		getInstallerHtml: function() {
			var a = "";
			return a += '<div id="qqlive_mminstaller_div"><OBJECT classid="clsid:' + e.config.MMINSTALL_CLSID + '" codebase="http://dl_dir.qq.com/qqtv/MMInstaller.cab#version=' + e.config.MMINSTALL_VER + '" ID="QQLiveInstaller" width="0px" height="0px">',
		...
		getActiveXObj: function(a, b) {
			...
			if (b && tvp.$.browser.isNotIESupport()) {
				if (c = document.embeds.FF_MM_Install, !c) {
					...
					d.innerHTML = e.installer.getInstallerHtml(),
	...
	function(a, b) {
		...
		j = function(c, d) {
			...
			j.checkLivePlayer = i,
			b.when(c.type == a.PLAYER_DEFINE.VOD ? e() : i(c.video)).then(function() {
				var e = "",
				g = function(b, d, f) {
					a.report({
						cmd: 3531,
				...
				"function" != typeof a[t] ? f(t, g).done(function() {
					p.call(d)
				}) : p.call(d)
			}),
			q
	...
	tvp.filename = "tvp.player_v2_jq.js",
	"function" == typeof define && define("tvp", [],
	function() {
		return tvp
	}),
	a.tvp = tvp,
	"undefined" != typeof e && (a.QQLive = e)
} (this);